...
The current question index and score are tracked in application state

User selections trigger event handlers that evaluate correctness
...
Implement a quiz restart option
